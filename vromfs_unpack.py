...
def decomp_and_write(file, is_store_temp_file=False):
    ...
    if is_store_temp_file:
        with open(file + '.dec', 'wb') as f:
            ...
            f.write(dec_data)
            f.write(tail_str)
    return head_str + dec_data + tail_str
...
def main():
    ...
    for i in xrange(total_files):
        ...
        content_size_off = struct.unpack_from('I', data, content_size_off_src)[0]
        print 'cont size: ' + str(content_size_off)
        content = data[content_off:content_off + content_size_off]
